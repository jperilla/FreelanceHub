    ...
    function initMyBookmarklet() {
        (window.freelanceBookmarklet = function () {
            if ($("#fh_frame").length == 0) {
                ...
                if ((title != "") && (title != null)) {
					...
					<div id='fh_frame'>\
						...
						<style type='text/css'>\
							...
							#fh_frame iframe { display: none; position: fixed; top: 10%; left: 10%; width: 30%; height: 80%; z-index: 999; border: 10px solid rgba(0,0,0,.5); margin: -5px 0 0 -5px; }\
						</style>\
					</div>");
                ...
                $("#fh_frame iframe").slideUp(500);
                setTimeout("$('#fh_frame').remove()", 750);
            }
