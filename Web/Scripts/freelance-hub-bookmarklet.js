            ...
            if ($("#freelance_hub_frame").length == 0) {
                ...
                if ((title != "") && (title != null)) {
					...
					<div id='freelance_hub_frame'>\
						...
						<iframe src='http://localhost:61413/Jobs/SaveExternalJob?&title=" + title + "&url=" + url + "&description=" + description + "' onload=\"$('#freelance_hub_frame iframe').slideDown(500);\">Enable iFrames.</iframe>\
						<style type='text/css'>\
